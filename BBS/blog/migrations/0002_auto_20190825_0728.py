# Generated by Django 2.2.3 on 2019-08-24 23:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='article2tag',
            options={'verbose_name': '文章-标签-多多', 'verbose_name_plural': '文章-标签-多多'},
        ),
        migrations.AlterModelOptions(
            name='articledetail',
        ...
        migrations.AlterModelOptions(
            name='category',
            options={'verbose_name': '博客文章分类', 'verbose_name_plural': '博客文章分类'},
        ),
        migrations.AlterModelOptions(
            name='comment',
